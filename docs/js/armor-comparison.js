...
function recalculate0()
{
	...
	if (sizeAcBonus == 0)
	{
		...
		if (armorSpeed0)
		{
			document.getElementById("speed0").innerText = 20;
		}
		else
		{
			document.getElementById("speed0").innerText = 30;
		}
	}
	else
	{
		...
		if (armorSpeed0)
		{
			document.getElementById("speed0").innerText = 15;
		}
		else
		{
			document.getElementById("speed0").innerText = 20;
...
function recalculate1()
{
	...
	if (sizeAcBonus == 0)
	{
		...
		if (armorSpeed0)
		{
			document.getElementById("speed1").innerText = 20;
		}
		else
		{
			document.getElementById("speed1").innerText = 30;
		}
	}
	else
	{
		...
		if (armorSpeed0)
		{
			document.getElementById("speed1").innerText = 15;
		}
		else
		{
			document.getElementById("speed1").innerText = 20;
